...
public class RoleResource {
	...
	public ResponseEntity<Object> deleteRole(@PathVariable("id") int role_id) {
	...
	public ResponseEntity<Object> deleteRole(@PathVariable("id") int role_id, @RequestBody UserRole role) {
